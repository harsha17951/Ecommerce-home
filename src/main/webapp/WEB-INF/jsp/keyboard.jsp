...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/61qYiQdxX8L._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>Gaming KeyBoard</h2>
                <p>EvoFox Deathray RGB Gaming Keyboard | 16 Million True Prism Colors</p>
                <h2>Price: $100.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/61dFslt5SML._SL1500_.jpg" alt="Card Image 1" style="height:400px;">
            <h2>
EvoFox Fireblade</h2>
            <div class="card-details">
                <p>
EvoFox Fireblade Wired TKL Gaming Keyboard with Breathing Effect |Backlit Keyboard Membrane | Mixed Color Lighting | Floating Keycaps |19 Anti-Ghosting Keys
</p>
                <h5><b><strong>price:$149.00</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/61q5a8-qkyL._SL1500_.jpg" alt="Card Image 2" style="height:400px;">
            <div class="card-details">
                <h2>HP K500F</h2>
                <p>HP K500F Backlit Membrane Wired Gaming Keyboard with Mixed Color Lighting, Metal Panel with Logo Lighting, 26 Anti-Ghosting Keys, and Windows Lock Key </p>
                <h5><b><strong>price:$190.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/71tG7kgNcJL._SL1500_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>https://m.media-amazon.com/images/I/71tG7kgNcJL._SL1500_.jpg</h2>
                <p>
Redragon K512 Shiva RGB Backlit Membrane Gaming Keyboard with Multimedia Keys, Linear Mechanical-Feel Switch, 6 Extra On-Board Macro Keys, Dedicated Media</p>
