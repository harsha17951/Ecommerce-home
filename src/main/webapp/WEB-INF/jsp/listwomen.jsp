    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          <strong class="d-block py-2">Different Kinds Of Women Clothing</strong>
          <div class="ms-auto">
                ...
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/918AAPTKEoL._UL1500_.jpg" class="w-100" style="height:200px;" />
                      <a href="#!">
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <br/>
                    <p class="text mb-4 mb-md-0">Zeel Clothing Women's Net Embroidered Semi-Stitched Bridal New Lehenga Choli with Dupatta</p>
                  </div>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src=https://m.media-amazon.com/images/I/71YSmxQ4waL._UX569_.jpg class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                      Weavers Villa - Women's Faux Pashmina Silk Paisley Design Shawls, Stoles</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
                      <h4 class="mb-1 me-1">$169.00</h4>
                      <span class="text-danger"><s>$269.00</s></span>
                    </div>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/71v5KX42hoL._UY741_.jpg" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                      AKHILAM Women's And Girls Embroidery Lace & Sequence Embroidery Chiffon Saree With Unstitched Blouse Piece
                    </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
                      <h4 class="mb-1 me-1">$219.00</h4>
                    </div>
                    <h6 class="text-success">Free shipping</h6>
                    <div class="mt-4">
                      <button class="btn btn-primary shadow-0" type="button">Buy this</button>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/51QoDT7P9qL._UY695_.jpg" class="card-img-top" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <br/><br/><br/>	
                    ...
                    <p class="text mb-4 mb-md-0">
                    	Van Heusen Women's Western (Brick)
                    </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                  <br/><br/><br/>	
                    <div class="d-flex flex-row align-items-center mb-1">
                      <h4 class="mb-1 me-1">$150.00</h4>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/31YY+SAt4TL.jpg" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
					Atasi International Gold Plated Crystal Necklace Jewellery Set with Earrings Suited for Party Wedding Festive for Women
					</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
