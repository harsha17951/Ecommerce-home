...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/916p1H2rbyL._UX679_.jpg" alt="Product Image">
            <div class="details">
                <h2>Denim Shorts</h2>
                <p>Blue jeans shorts for men in S,M,L,XL sizes</p>
                <h2>Price: $17.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://rukminim2.flixcart.com/image/832/832/kjd6nww0-0/cargo/k/r/z/34-men-cargos-45636269-ochrestar-original-imafyy2tkgfktrwa.jpeg?q=70" alt="Card Image 1" style="height:575px;">
            <h2>Cargo pants</h2>
            <div class="card-details">
                <p>Light Coloured Cargo Pants for men
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/81JiFWdBr5L._UY741_.jpg" alt="Card Image 2" style="height:575px;">
            <div class="card-details">
                <h2>Denim Jogger</h2>
                <p>EditLook Men's 6 Pocket Slim Fit Denim Blend Cargo Jogger</p>
                <h5><b><strong>price:$120.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/51aoARKKldL.jpg" alt="Card Image 3" style="height:575px;">
            <div class="card-details">
                <h2>Denim Shorts</h2>
                <p>chopper club Boys Denim Shorts with Inner Elastic in Stretchable 3x1 Denim Fabric Regular Fit</p>
