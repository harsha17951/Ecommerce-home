...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/41EjaRq8G6L._SL1000_.jpg" alt="Product Image">
            <div class="details">
                <h2>PenDrive</h2>
                <p>SanDisk Ultra 128 GB USB 3.0 Pen Drive (Black)</p>
                <h2>Price: $36.50</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/61MtrB2hqcL._SL1500_.jpg" alt="Card Image 1" style="height:400px;">
            <h2>Sandisk USB 3.2</h2>
            <div class="card-details">
                <p>SanDisk Ultra Luxe USB 3.2 Flash Drive 128GB, Upto 400MB/s, All Metal, Metallic Silver</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/61-Loy+RGYL._SL1500_.jpg" alt="Card Image 2" style="height:400px;">
            <div class="card-details">
                <h2>
HP 712w 32GB</h2>
                <p>
HP 712w 32GB USB 3.2 Flash Drive- Blue</p>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/71qOWNxv4jL._SL1500_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>
SanDisk Ultra Dual Drive </h2>
                <p>
SanDisk Ultra Dual Drive Go USB Type C Pendrive for Mobile (Black, 128 GB, 5Y - SDDDC3-128G-I35)</p>
