...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/61xDrX2r5uL._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>USB HUB</h2>
                <p>Verilux ® USB C Hub Multiport Adapter 6 in 1 Portable Aluminum USB Extender with 4K HDMI(30Hz), PD 87W, USB 3.0 Port, SD/Micro SD Card Reader, USB Type C</p>
                <h2>Price: $30.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/51Ca3ygF8PS._SL1200_.jpg" alt="Card Image 1" style="height:400px;">
            <h2>
Amkette 4 Port</h2>
            <div class="card-details">
                <p>
Amkette 4 Port Superspeed USB Hub 3.0 for PC/Laptops, Portable Data Hub with Hi-Speed Data Transfer Up to 5 GBPS |Charging Function| Strong and Durable
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/61BmOE1fMkL._SL1500_.jpg" alt="Card Image 2" style="height:400px;">
            <div class="card-details">
                <h2>
Portronics Mport 31</h2>
                <p>
Portronics Mport 31 Plus USB 3.0 Hub (5-in-1) with USB & Type-C Dual Plugs, Upto 5 Gbps High Speed, USB 3.0, 2-Port USB 2.0 & SD/microSD Card Reader</p>
                <h5><b><strong>price:$30.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/51MIg1rpNbS._SL1024_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>USB Hub 3.0 for PC</h2>
                <p>
Verilux® USB Hub 3.0 for PC Multiport Adapter with 4 USB Ports High Speed 3.0 USB Hub for Laptop Aluminium USB Extender with Multi USB Port for MacBook</p>
                <h5><b><strong>price:$30.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
