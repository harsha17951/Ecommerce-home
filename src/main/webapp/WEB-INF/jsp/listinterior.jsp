        ...
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          ...
          <div class="ms-auto">
            ...
            <div class="btn-group shadow-0 border">
              ...
              <a href="interior" class="btn btn-light active" title="Grid view">
                ...
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/91FwdCVfcJL._SL1500_.jpg" class="w-100" />
                      <a href="#!">
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                      Global Grabbers Polyresin Sitting Buddha Idol Statue Showpiece for Homedecor Decoration
                    </p>
                  </div>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/819p02LqgBL._SL1500_.jpg" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                      Freny Exim 12" Inch Wooden Wall Clock
                    </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/41SbR-9cywL.jpg" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                      Wooden Showcase for Living Room,Wall Shelf for Living Room
                    </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://assets-news.housing.com/news/wp-content/uploads/2018/01/30131629/10-home-decor-trends-that-will-rule-in-2021-shutterstock_1052524961.jpg" class="card-img-top" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                    	This chair can be hanged to top wall and can turn around
                    </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/41+sO-+kccL.jpg" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
						F N Finautica Wooden Italian Wooden Crafter Standard Size Tripod Floor Lamp   				
                    </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
