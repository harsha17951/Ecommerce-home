...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/811GOkDSOaL._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>Apple Watch Ultra 2</h2>
                <p>Apple Watch Ultra 2 [GPS + Cellular 49mm] Smartwatch with Rugged Titanium Case & Blue Ocean Band One Size. Fitness Tracker, Precision GPS, Action Button</p>
                <h2>Price: $39.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71lG7br7k1L._SL1500_.jpg" alt="Card Image 1" style="height:475px;">
            <h2>Apple Watch</h2>
            <div class="card-details">
                <p>Apple iwatch with free size straps
</p>
                <h5><b><strong>price:$29.95</strong></b></h5>
                <a href="iwatch"><button>View Details</button></a>
            </div>
        </div>
