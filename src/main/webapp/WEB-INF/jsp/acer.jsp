...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/71F8KF5t8ML._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>ACER Curved monitor</h2>
                <p>Acer XZ396Q 38.5 Inch (97.79 Cm) 2560 x 1440 Pixels Led 3000R Curve WQHD VA Panel LCD Monitor with LED Back Light Technology</p>
                <h2>Price: $421.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71fgHQy31ZL._SL1500_.jpg" alt="Card Image 1" style="height:400px;">
            <h2>Acer Aspire 3</h2>
            <div class="card-details">
                <p>Acer Aspire 3 Intel Core i5 12th Generation Laptop (Windows 11 Home/16GB/512 GB SSD/MS Office) A315-59 with 39.6 cm (15.6") Full HD Display, 1.7 Kg, Silver

</p>
                <h5><b><strong>price:$421.00</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/61xzutxSl8L._SL1200_.jpg" alt="Card Image 2" style="height:400px;;">
            <div class="card-details">
                <h2>Acer Aspire 5</h2>
                <p>Acer Aspire 5 Gaming Laptop Intel Core i5 12th gen (16 GB/512 GB SSD/Win11 Home/4GB Graphics/RTX 2050) A515-57G (15.6" FHD Display, 1.8 Kg)
</p>
                <h5><b><strong>price:$421.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/617rprfdhRL._SL1500_.jpg" alt="Card Image 3" style="height:400px;;">
            <div class="card-details">
                <h2>Acer Aspire Lite</h2>
                <p>Acer Aspire Lite 11th Gen Intel Core i3 Premium Metal Laptop (8GB RAM/512GB SSD/Windows 11 Home) AL15-51, 39.62cm (15.6") Full HD Display, Metal Body</p>
