...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://i.etsystatic.com/7763764/r/il/9ddb5a/2047788376/il_794xN.2047788376_afsd.jpg" alt="Product Image">
            <div class="details">
                <h2>MENS WALLET</h2>
                <p>MENS WALLET, Mens Leather Wallets, Wallets for Men, Wallets for Women, Mens Wallets, Leather Wallets for Men</p>
                <h2>Price: $10.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71tZtxBhOJL._SL1500_.jpg" alt="Card Image 1" style="height:275px;">
            <h2>Leather Wallet</h2>
            <div class="card-details">
                <p>WildHorn Blue Leather Wallet for Men I 9 Card Slots I 2 Currency & 2 Secret Compartments I 1 Zipper & 3 ID Card Slots</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/61czxn2e7jL._UY695_.jpg" alt="Card Image 2" style="height:275px;">
            <div class="card-details">
                <h2>Flip Top Wallet</h2>
                <p>DailyObjects Flip Top Card Wallet for Men</p>
                <h5><b><strong>price:$10.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/618FEBO12vL._UY695_.jpg" alt="Card Image 3" style="height:275px;">
            <div class="card-details">
                <h2>Cards Wallet </h2>
                <p>DailyObjects Skinny Fit Card Wallet</p>
                <h5><b><strong>price:$10.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
