...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/91W3-v1f3IL._UX679_.jpg" alt="Product Image">
            <div class="details">
                <h2>Bag</h2>
                <p>VELLORA Gladiator Travel Laptop Backpack</p>
                <h2>Price: $29.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71HVRCqpnqL._UL1500_.jpg" alt="Card Image 1" style="height:575px;">
            <h2>Laptop Bag</h2>
            <div class="card-details">
                <p>Skybags 30 Ltrs Black Casual Backpack (BPSTRP4HBLK)
</p>
                <h5><b><strong>price:$100.00</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/81KEKEDFUcL._SL1500_.jpg" alt="Card Image 2" style="height:575px;">
            <div class="card-details">
                <h2>Casual Backpack</h2>
                <p>American Tourister Fizz Large Size 32 Ltrs Casual Backpack (BLACK)</p>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/61XHRNNnEVL._UL1500_.jpg" alt="Card Image 3" style="height:575px;">
            <div class="card-details">
                <h2>large Laptop bag</h2>
                <p>Safari Swagpack 35 Ltrs Large Laptop Backpack With 3 Compartments and Raincover - Black (SWAGPACK19CBBLK)</p>
