...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/51erlDVGq1L._UX569_.jpg" alt="Product Image">
            <div class="details">
                <h2>Sweat Shirt</h2>
                <p>Slim fit T-shirt for men available in the sizes S,M,L,XL</p>
                <h2>Price: $9.50</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://rukminim2.flixcart.com/image/416/416/xif0q/t-shirt/w/8/l/l-all-rbc-white-one-nb-nicky-boy-original-imagpyct8f5hhauz.jpeg?q=70" alt="Card Image 1" style="height:575px;">
            <h2>Hoodie</h2>
            <div class="card-details">
                <p>Red Coloured Hoodie For Men
</p>
                <h5><b><strong>price:$120.00</strong></b></h5>
                <a href="redhoodie"><button>View Details</button></a>
            </div>
        </div>
