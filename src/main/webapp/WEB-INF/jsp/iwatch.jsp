...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/71lG7br7k1L._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>I-Watch</h2>
                <p>Apple iwatch with free size straps</p>
                <h2>Price: $29.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/811GOkDSOaL._SL1500_.jpg" alt="Card Image 1" style="height:475px;">
            <h2>Apple Watch Ultra 2</h2>
            <div class="card-details">
                <p>Apple Watch Ultra 2 [GPS + Cellular 49mm] Smartwatch with Rugged Titanium Case & Blue Ocean Band One Size. Fitness Tracker, Precision GPS, Action Button
</p>
                <h5><b><strong>price:$39.95</strong></b></h5>
                <a href="iwatch1"><button>View Details</button></a>
            </div>
        </div>

        <!-- Second card below the picture -->
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/810wzMG3BJL._SL1500_.jpg" alt="Card Image 2" style="height:475px;">
            <div class="card-details">
                <h2>Apple Watch Series 9</h2>
                <p>Apple Watch Series 9 [GPS 45mm] Smartwatch with Midnight Aluminum Case with Midnight Sport Loop One Size. Fitness Tracker, Blood Oxygen & ECG Apps</p>
                <h5><b><strong>price:$49.99</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/71CrNuzQaHL._SL1500_.jpg" alt="Card Image 3" style="height:475px;">
            <div class="card-details">
                <h2>
Apple Watch Series 7</h2>
                <p>
Apple Watch Series 7 (GPS + Cellular, 41mm) - Midnight Aluminium Case with Midnight Sport Band - Regular</p>
                <h5><b><strong>price:$39.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
    </div>
