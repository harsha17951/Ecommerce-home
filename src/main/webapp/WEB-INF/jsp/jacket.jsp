...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/81bBwHn9NBL._UX679_.jpg" alt="Product Image">
            <div class="details">
                <h2>Jacket</h2>
                <p>Jacket For Girls Of Sizes S,M,L,Xl</p>
                <h2>Price: $29.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/61Hejb+YFwL._UY741_.jpg" alt="Card Image 1" style="height:575px;">
            <h2>Winter jacket</h2>
            <div class="card-details">
                <p>UniSex Winter Jacket for Men and Women, All sizes
</p>
                <h5><b><strong>price:$120.00</strong></b></h5>
                <a href="menjacket"><button>View Details</button></a>
            </div>
        </div>
