...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/61dgg4KIRzL._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>MI BUDS</h2>
                <p>Redmi Buds 4 Active - Bass Black, 12mm Drivers(Premium Sound Quality), Up to 30 Hours Battery Life</p>
                <h2>Price: $19.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/211N1lniyoL.jpg" alt="Card Image 1" style="height:400px;">
            <h2>Redmi Earbuds 3 Pro</h2>
            <div class="card-details">
                <p>Redmi Earbuds 3 Pro Truly Wireless in-Ear Earbuds with Mic, Up-to 30 Hours Playback, Bluetooth 5.2, Qualcomm® aptX Adaptive Audio Technology, 86 ms Low Latency
</p>
                <h5><b><strong>price:$19.00</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/61fYI7Y1h5L._SL1500_.jpg" alt="Card Image 2" style="height:400px;">
            <div class="card-details">
                <h2>
Redmi Buds 3 Lite</h2>
                <p>Canon EOS R8 Full-Frame Mirrorless Camera (Body Only) with 24.2 MP, 4K Video, DIGIC X Image Processor (Black)</p>
                <h5><b><strong>price:$19.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/51PzaL2D0sL._SL1500_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>realme Buds T300</h2>
                <p>
realme Buds T300 Truly Wireless in-Ear Earbuds with 30dB ANC, 360° Spatial Audio Effect, 12.4mm Dynamic Bass Boost Driver with Dolby Atmos Support</p>
                <h5><b><strong>price:$19.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
