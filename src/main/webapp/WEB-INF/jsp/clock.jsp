...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/51xngAwpYFL._SX300_SY300_QL70_FMwebp_.jpg" alt="Product Image">
            <div class="details">
                <h2>CLOCK</h2>
                <p>Amazon Brand - Solimo 12-inch Contemporary Plastic & Glass Wall Clock - Designer (Silent Movement, Black Frame)</p>
                <h2>Price: $36.50</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/81cMi1hGtML._SL1500_.jpg" alt="Card Image 1" style="height:400px;">
            <h2>Metal Wall Clock </h2>
            <div class="card-details">
                <p>
Craftter Premium Roman Sculpture Abstract Art Metal Wall Clock (Copper, 75 cm)
</p>
                <h5><b><strong>price:$50.00</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/81JWPmikuxS._SL1500_.jpg" alt="Card Image 2" style="height:400px;">
            <div class="card-details">
                <h2>Metal Wall Clock</h2>
                <p>
Craftter 30 inch Stainless Steel Textured Finish Metal Wall Clock</p>
                <h5><b><strong>price:$59.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/71WgfW3-maL._SL1500_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>Wall Hanging Clock</h2>
                <p>
Craftter Metal Wall Clock for Living Room Bedroom Decor,Big Size Modern Wall Watch,Wall Hanging Clock,Fancy Modern Wall Watch for Bedroom,Office</p>
                <h5><b><strong>price:$59.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
