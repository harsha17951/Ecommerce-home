...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/81dcZW0Fm4L._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>ASUS</h2>
                <p>ASUS Zenbook 17 Fold OLED, Intel EVO Core i7 12th Gen</p>
                <h2>Price: $999.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71DBkrxqBDL._SL1500_.jpg" alt="Card Image 1" style="height:400px;">
            <h2>ASUS S15 OLED </h2>
            <div class="card-details">
                <p>ASUS Vivobook S15 OLED 2022, 15.6" 39.62 cm FHD OLED, Intel Core Evo i5-12500H 12th Gen, Thin and Light Laptop (16GB/512GB SSD/Iris Xe Graphics
</p>
                <h5><b><strong>price:$599.00</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/71T9b+tyAtL._SL1500_.jpg" alt="Card Image 2" style="height:400px;;">
            <div class="card-details">
                <h2>ASUS K15 OLED</h2>
                <p>ASUS VivoBook K15 OLED (2021), 15.6" (39.62 cms) FHD OLED, Intel Core i3-1115G4 11th Gen, Thin and Light Laptop (8GB/512GB SSD</p>
                <h5><b><strong>price:$599.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/713CEMGw3yL._SL1500_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>ASUS Vivobook 14 OLED</h2>
                <p>ASUS Vivobook 14 OLED,12th Gen Intel Core i3-1215U,14"(35.56 cm) 2.8K OLED 16:10 90Hz,Thin & Laptop(8GB/512GB SSD/Windows 11 Home/Office</p>
                <h5><b><strong>price:$599.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
