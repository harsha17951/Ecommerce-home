...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://rukminim2.flixcart.com/image/416/416/xif0q/t-shirt/w/8/l/l-all-rbc-white-one-nb-nicky-boy-original-imagpyct8f5hhauz.jpeg?q=70" alt="Product Image"style="width:1000px;">
            <div class="details">
                <h2>Hoodie</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/51erlDVGq1L._UX569_.jpg" alt="Card Image 1" style="height:575px;">
            <h2>Sweat Shirt</h2>
            <div class="card-details">
                <p>Slim fit T-shirt for men available in the sizes S,M,L,XL
</p>
                <h5><b><strong>price:$9.50</strong></b></h5>
                <a href="tshirt"><button>View Details</button></a>
            </div>
        </div>

        <!-- Second card below the picture -->
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/sweatshirt/w/d/j/s-hood1-do-four-lines-n-fashion-and-youth-original-imaghk5gxfcjfzyp.jpeg?q=70" alt="Card Image 2" style="height:575px;">
            <div class="card-details">
                <h2>Solid Hoodie</h2>
                <p>Men Full Sleeve Solid Hooded Sweatshirt</p>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/shirt/w/w/f/m-double-pocket-shirt-qlonz-store-original-imagsze7yyzmvrdc.jpeg?q=70" alt="Card Image 3" style="height:575px;">
            <div class="card-details">
                <h2>Double Pocket Shirts</h2>
                <p>Summer New Men's Double pocket Shirts</p>
                <h5><b><strong>price:$44.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
    </div>
