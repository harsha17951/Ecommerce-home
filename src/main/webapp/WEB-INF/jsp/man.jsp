...
<html>
<header>
<title>Ecommerce:Men's Clothing</title>
        ...
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          ...
          <div class="ms-auto">
            ...
            <div class="btn-group shadow-0 border">
              <a href="listman" class="btn btn-light" title="List view">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/shopsy-t-shirt/e/j/a/xl-maroon-tshirt-nadni-fashion-original-imaggf75qffzppxg.jpeg?q=70" class="card-img-top" style="height:400px;"/>
              <div class="card-body d-flex flex-column">
                <div class="d-flex flex-row">
                  <h5 class="mb-1 me-1">$34.50</h5>
                  <span class="text-danger"><s>$49.99</s></span>
                </div>
                <p class="card-text">T-shirts with multiple colors, for men</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="halfhand" class="btn btn-primary shadow-0 me-1">View Details</a>
                  <a href="#!" class="btn btn-primary shadow-0 me-1" style="margin-left:20px;">Add to cart</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/61Hejb+YFwL._UY741_.jpg" class="card-img-top" />
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$120.00</h5>
                <p class="card-text">Winter Jacket for Men and Women, All sizes</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="menjacket" class="btn btn-primary shadow-0 me-1">View Details</a>
                  <a href="#!" class="btn btn-primary shadow-0 me-1" style="margin-left:20px;">Add to cart</a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://rukminim2.flixcart.com/image/416/416/xif0q/t-shirt/w/8/l/l-all-rbc-white-one-nb-nicky-boy-original-imagpyct8f5hhauz.jpeg?q=70" class="card-img-top" style="height:400px;"/>
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$120.00</h5>
                <p class="card-text">Red Coloured Hoodie For Men</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="redhoodie" class="btn btn-primary shadow-0 me-1">View Details</a>
                  <a href="#!" class="btn btn-primary shadow-0 me-1" style="margin-left:20px;">Add to cart</a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/41PzalMgEuL.jpg" class="card-img-top" style="aspect-ratio: 1 / 1"/>
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$120.00</h5>
                <p class="card-text">Blazer Suit Dress Jacket for Men, Blue color</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                 <a href="Blazer" class="btn btn-primary shadow-0 me-1">View Details</a>
                  <a href="#!" class="btn btn-primary shadow-0 me-1" style="margin-left:20px;">Add to cart</a>
</div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/51eznmtJlNL._SX300_SY300_.jpg" class="card-img-top" style="aspect-ratio: 1 / 1" />
              <div class="card-body d-flex flex-column">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://rukminim2.flixcart.com/image/832/832/ky1vl3k0/t-shirt/e/s/9/xxs-tomcut-petrolblue-lauren-adams-original-imagadgduadasgzp.jpeg?q=70" class="card-img-top" />
              <div class="card-body d-flex flex-column">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://rukminim2.flixcart.com/image/832/832/kjd6nww0-0/cargo/k/r/z/34-men-cargos-45636269-ochrestar-original-imafyy2tkgfktrwa.jpeg?q=70" class="card-img-top" style="height:400px;" />
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$120.00</h5>
                <p class="card-text">Cargo Pants for men</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/sweatshirt/w/d/j/s-hood1-do-four-lines-n-fashion-and-youth-original-imaghk5gxfcjfzyp.jpeg?q=70" class="card-img-top"  style="height:400px;"/>
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$120.00</h5>
                <p class="card-text">Men Full Sleeve Solid Hooded Sweatshirt</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/shirt/w/w/f/m-double-pocket-shirt-qlonz-store-original-imagsze7yyzmvrdc.jpeg?q=70" class="card-img-top" style="height:400px;"/>
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$43.50</h5>
                <p class="card-text">Summer New Men's Double pocket Shirts</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
