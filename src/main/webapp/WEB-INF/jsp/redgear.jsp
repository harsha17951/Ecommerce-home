...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/71PhCZEGH7L._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>Red Gear</h2>
                <p>Red gear Wired HeadPhones with Free Size</p>
                <h2>Price: $29.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/51E5VhH13kL._SL1000_.jpg" alt="Card Image 1" style="height:475px;">
            <h2>HyperX Cloud Stinger 2</h2>
            <div class="card-details">
                <p>HyperX Cloud Stinger 2 Core Gaming Headset for Playstation-White (6H9B5Aa),Over Ear,Wired
</p>
                <h5><b><strong>price:$29.99</strong></b></h5>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/71RSZdY7pJL._SL1500_.jpg" alt="Card Image 2" style="height:475px;">
            <div class="card-details">
                <h2>Logitech G733 </h2>
                <p>Logitech G733 Lightspeed Bluetooth Wireless On Ear Headphones with Mic Gaming with Suspension Headband, Lightsync RGB, Blue Vo!Ce Mic Technology</p>
                <h5><b><strong>price:$29.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/61Z4cWR+TOL._SL1500_.jpg" alt="Card Image 3" style="height:475px;">
            <div class="card-details">
                <h2>EvoFox Aurora</h2>
                <p>EvoFox Aurora USB Gaming wired Over Ear Headphones With 7.1 Dynamic Surround Sound | Adjustable Boom Mic | RGB Backlight | Protein Leather Ear Cushion</p>
                <h5><b><strong>price:$29.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
