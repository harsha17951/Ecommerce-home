...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/61nBzBREzGL._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>Galaxy </h2>
                <p>
Samsung Galaxy Watch4 Bluetooth(4.0 cm, Black)</p>
                <h2>Price: $29.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71IWZWuhk7L._SL1500_.jpg" alt="Card Image 1" style="height:375px;">
            <h2>Galaxy Watch6</h2>
            <div class="card-details">
                <p>Samsung Galaxy Watch6 LTE (44mm, Silver, Compatible with Android only)
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/6128OgyhQTL._SL1500_.jpg" alt="Card Image 2" style="height:375px;">
            <div class="card-details">
                <h2>Galaxy Watch4</h2>
                <p>Samsung Galaxy Watch4 Classic LTE (4.6cm, Black)</p>
                <h5><b><strong>price:$39.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/61Guilj8MEL._SL1500_.jpg" alt="Card Image 3" style="height:375px;">
            <div class="card-details">
                <h2>Galaxy Watch5</h2>
                <p>Samsung Galaxy Watch5 Bluetooth (44 mm, Graphite, Compatible with Android only)</p>
