...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/71O-r5I0PtL._UX569_.jpg" alt="Product Image">
            <div class="details">
                <h2>Sleeve Shirt</h2>
                <p>Cotton Blend Stitched Solid Full Sleeve Shirt</p>
                <h2>Price: $29.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://rukminim2.flixcart.com/image/832/832/xif0q/shirt/w/w/f/m-double-pocket-shirt-qlonz-store-original-imagsze7yyzmvrdc.jpeg?q=70" alt="Card Image 1" style="height:575px;">
            <h2>Double Pocket Shirt</h2>
            <div class="card-details">
                <p>Summer New Men's Double pocket Shirts
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/41KdMGFbJpL.jpg" alt="Card Image 2" style="height:575px;">
            <div class="card-details">
                <h2>Cotton Double Pocket Shirt</h2>
                <p>ZAKOD Regular Fit Full Sleeve Summer Wear Cotton Double Pocket Shirt</p>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/51g3U8bsKJL._UX679_.jpg" alt="Card Image 3" style="height:575px;">
            <div class="card-details">
                <h2>Slim fit Kurta</h2>
                <p>Vida Loca Full Sleeve Chinese/Rounded/Collar Pure Cotton Casual, Wedding, Party, Festival Stylish Latest Short Length Slim fit Kurta Style Shirt for Men and Boys. (Beige 36)</p>
                <h5><b><strong>price:$159.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
    </div>
