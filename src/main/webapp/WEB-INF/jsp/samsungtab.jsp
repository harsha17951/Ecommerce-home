...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/61vsK7h3zVL._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>SAMSUNG TABS</h2>
                <p>Samsung Galaxy Tab S6 Lite 26.31 cm (10.4 inch), S-Pen in Box, Slim and Light, Dolby Atmos Sound</p>
                <h2>Price: $199.99</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/915rA4VNXuL._SL1500_.jpg" alt="Card Image 1" style="height:400px;;">
            <h2>Galaxy Tab S7</h2>
            <div class="card-details">
                <p>Samsung Galaxy Tab S7 FE 31.5 cm (12.4 inch) Large Display, S-Pen in Box, Slim Metal Body, Dolby Atmos Sound, RAM 4 GB, ROM 64 GB Expandable, Wi-Fi Tablet
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/61afkty1foL._SL1500_.jpg" alt="Card Image 2" style="height:400px;;">
            <div class="card-details">
                <h2>Galaxy Tab A9+</h2>
                <p>
Samsung Galaxy Tab A9+ 27.94 cm (11.0 inch) Display, RAM 8 GB, ROM 128 GB Expandable, Wi-Fi Tablet, Gray</p>
                <h5><b><strong>price:$149.99</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/715vnqRA08L._SL1500_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>MI Pad</h2>
                <p>
Redmi Pad | MediaTek Helio G99 | 26.95cm (10.61 inch) 2K Resolution & 90Hz Refresh Rate Display | 6GB RAM & 128GB Storage, Expandable up to 1TB</p>
                <h5><b><strong>price:$150.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
    </div>
