...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/61Hejb+YFwL._UY741_.jpg" alt="Product Image">
            <div class="details">
                <h2>Winter Jacket</h2>
                <p>Winter Jacket for Men and Women, All sizes</p>
                <h2>Price: $120.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/81bBwHn9NBL._UX679_.jpg" alt="Card Image 1" style="height:475px;">
            <h2>Jacket</h2>
            <div class="card-details">
                <p>Jacket For Girls Of Sizes S,M,L,Xl
</p>
                <h5><b><strong>price:$29.953</strong></b></h5>
                <a href="jacket"><button>View Details</button></a>
            </div>
        </div>

        <!-- Second card below the picture -->
       <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/5179aTMeDFL._UL1080_.jpg" alt="Card Image 2" style="height:575px;">
            <div class="card-details">
                <h2>Cotton jacket</h2>
                <p>L'MONTE Men's Cotton Standard Length Jacket</p>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/51o6x2GXe4L._UX466_.jpg" alt="Card Image 3" style="height:575px;">
            <div class="card-details">
                <h2>Sport's Jacket</h2>
                <p>Nike Men's Sports Jacket</p>
