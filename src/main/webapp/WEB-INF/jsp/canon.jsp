...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/914hFeTU2-L._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>CANON</h2>
                <p>Canon EOS professional with 128GB Internal Capacity</p>
                <h2>Price: $590.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71eOQ5ssTAL._SL1500_.jpg" alt="Card Image 1" style="height:275px;">
            <h2>Canon EOS R6</h2>
            <div class="card-details">
                <p>
Canon Digital Camera EOS R6 Mark II with 24-105 STM Kit Black
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/71sDMZ0GqKL._SL1500_.jpg" alt="Card Image 2" style="height:275px;">
            <div class="card-details">
                <h2>Canon EOS R8</h2>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/81w6OTA6l3L._SL1500_.jpg" alt="Card Image 3" style="height:275px;">
            <div class="card-details">
                <h2>
Canon EOS 200D</h2>
                <p>
Canon EOS 200D II 24.1MP Digital SLR Camera + EF-S 18-55mm f4 is STM Lens (Black) with Canon EF50MM F/1.8 STM Lens</p>
                <h5><b><strong>price:$590.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
