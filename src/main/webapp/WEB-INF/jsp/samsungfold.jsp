...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="img/fold.png" alt="Product Image" style="width:500px;">
            <div class="details">
                <h2>SAMSUNG Z FOLD</h2>
                <p>Samsung Galaxy Z Fold5 5G (ICY Blue, 12GB RAM, 512GB Storage)</p>
                <h2>Price: $499.99</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/71f2I8cltBL._SL1500_.jpg" alt="Card Image 1" style="height:400px;">
            <h2>Samsung Z Flip3</h2>
            <div class="card-details">
                <p>
Samsung Galaxy Z Flip3 5G (Cream, 8GB RAM, 128GB Storage) with No Cost EMI
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/81PcAHZxgLL._SL1500_.jpg" alt="Card Image 2" style="height:400px;">
            <div class="card-details">
                <h2>
Samsung Galaxy M13</h2>
                <p>
Samsung Galaxy M13 (Midnight Blue, 6GB, 128GB Storage) | 6000mAh Battery | Upto 12GB RAM with RAM Plus</p>
                <h5><b><strong>price:$590.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/71XwXWxa6QL._SL1500_.jpg" alt="Card Image 3" style="height:400px;">
            <div class="card-details">
                <h2>Galaxy Z Fold5</h2>
                <p>
Samsung Galaxy Z Fold5 5G (ICY Blue, 12GB RAM, 256GB Storage)</p>
