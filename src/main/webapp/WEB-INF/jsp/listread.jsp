                ...
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/41X0h5x+XZL.jpg" class="w-100" style="height:200px;" />
                      <a href="#!">
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <br/>
                    <p class="text mb-4 mb-md-0">Iron Jkfolding Chairs For Home and study                 </p>
                  </div>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src=https://m.media-amazon.com/images/I/218G80xTeAL.jpg class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                      3nh® Flexible Reading Table Desk Study Light Lamp with Magnifying Glass Bright White
                                          </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
                      <h4 class="mb-1 me-1">$149.00</h4>
                      <span class="text-danger"><s>$249.00</s></span>
                    </div>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/41NebFGMu2L._SY466_.jpg" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/411M-rKbr3L.jpg" class="card-img-top" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
                    	Pentonic Extra Dark Graphite Pencil Tumbler Pack
                    </p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
                      <h4 class="mb-1 me-1">$99.00</h4>
                      <span class="text-danger"><s>$199</s></span>
                    </div>
                    <h6 class="text-success">Free shipping</h6>
                    <div class="mt-4">
                      <button class="btn btn-primary shadow-0" type="button">Buy this</button>
            ...
            <div class="card shadow-0 border rounded-3">
              <div class="card-body">
                <div class="row g-0">
                  <div class="col-xl-3 col-md-4 d-flex justify-content-center">
                    <div class="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                      <img src="https://m.media-amazon.com/images/I/61S66NMwjrL._SL1000_.jpg" class="w-100" />
                      <a href="#!">
                        <div class="hover-overlay">
                          <div class="mask" style="background-color: rgba(253, 253, 253, 0.15);"></div>
                        </div>
                  ...
                  <div class="col-xl-6 col-md-5 col-sm-7">
                    ...
                    <p class="text mb-4 mb-md-0">
					Radiant Writers Glitter Gel Pens - Set of 8
					</p>
                  </div>
                  <div class="col-xl-3 col-md-3 col-sm-5">
                    <div class="d-flex flex-row align-items-center mb-1">
                      <h4 class="mb-1 me-1">$10.00</h4>
                      <span class="text-danger"><s>$29</s></span>
                    </div>
                    <h6 class="text-success">Free shipping</h6>
                    <div class="mt-4">
                      <button class="btn btn-primary shadow-0" type="button">Buy this</button>
