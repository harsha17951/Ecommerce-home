    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          <strong class="d-block py-2">Different Kinds Of Kids Toys</strong>
          <div class="ms-auto">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/61A2ddWFQxL._SL1500_.jpg" class="card-img-top" style="height:400px;" />
              ...
              <div class="card-body d-flex flex-column">
                ...
                <p class="card-text">
Amazon Brand - Jam & Honey Penguin, Plush/Soft Toy for Boys, Girls and Kids, Super-Soft, Safe, Great Birthday Gift (Black and White, 17 cm)</p>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/61D88U416UL._SL1500_.jpg" class="card-img-top" style="height:400px;"/>
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$249.00</h5>
                <p class="card-text"style="height:">Jam & Honey Scooter (Shark, Oval) for Kids | Height Adjustable | Foldable | Scratch Free Wheels</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/61zZ9akSPbL._SL1500_.jpg" class="card-img-top" style="height:400px;" />
            
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$79.00</h5>
                <p class="card-text">TRU TOYS Remote Control Helicopter Toy Hand Sensor USB Charging Exceed Infrared Induction Flight </p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/81MCG-6qvnL._SL1500_.jpg" class="card-img-top" style="aspect-ratio: 1 / 1"/>
              <div class="card-body d-flex flex-column">
              <br/><br/><br/><br/><br/>
                <h5 class="card-title">$199.00</h5>
                <p class="card-text">
LuvLap Starlight Ride on & Car for Kids with Music & Horn Steering, Push Car for Baby with Backrest</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/514crChn+2L.jpg" class="card-img-top" style="aspect-ratio: 1 / 1" />
              <div class="card-body d-flex flex-column">
              <br/><br/><br/><br/><br/>
                <h5 class="card-title">$50.00</h5>
                <p class="card-text">Toy Imagine 8.5 inch LCD Writing Tablet for Kids Digital Magic Slate</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/811tEgKg4uL._SL1500_.jpg" class="card-img-top"/>
              <br/><br/>
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$129.99</h5>
                <p class="card-text">Jam & Honey Tricycle for Kids | Plug N Play | Parental Handle and Seatbelt (Red)</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/71cKF9eGZGL._SL1500_.jpg" class="card-img-top"style="height:350px;" />
              <br/><br/>
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$50.00</h5>
                <p class="card-text">GRAPHENE Monster Truck for Boys 3 4 5 6 7 Year Old,Push and Go Friction Powered Car</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/610gfNhqn8L._SL1201_.jpg" class="card-img-top" style="height:350px;" />
              <br/><br/>	
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$15.00</h5>
                <p class="card-text">
Little's Soft Plush Baby Ball with Rattle Sound (Size 11 cm, M, Multi color, Softball)</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
            <div class="card w-100 my-2 shadow-2-strong">
              <img src="https://m.media-amazon.com/images/I/61+J3PayEoL._SL1200_.jpg" class="card-img-top" style="height:400px;"/>
           
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">$90.00</h5>
                <p class="card-text">
Toyzone Eco Panda Magic Car Swing Car | Baby Car | Kids Car | Toy Car | Push Car |</p>
                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                  <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                  <a href="#!" class="btn btn-light border icon-hover px-2 pt-2"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                </div>
