...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/41a4-vgETkL._AC_SY200_.jpg" alt="Product Image"style="width:1000px;">
            <div class="details">
                <h2>MI Laptop</h2>
                <p>Xiaomi Notebook Ultra 11th Gen Intel Core i5-11320H Thin & Light (8GB/512GB SSD/Iris Xe Graphics</p>
                <h2>Price: $499.00</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/61hehrUJFvL._SL1500_.jpg" alt="Card Image 1" style="height:275px;">
            <h2>MI NoteBook Ultra Max</h2>
            <div class="card-details">
                <p>Xiaomi Notebook Ultra Max 11th Gen Intel Core i5-11320H Thin & Light (16GB/512GB SSD/Iris Xe Graphics/15.6" 3.2K Resolution/Win 11/Thunderbolt 4/MS office
</p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/71D-xbvtz-L._SL1500_.jpg" alt="Card Image 2" style="height:275px;">
            <div class="card-details">
                <h2>Xiaomi Notebook Pro 120</h2>
                <p>Xiaomi Notebook Pro 120 12th Gen Intel i5-12450H Thin & Light (16GB LPDDR5 RAM/512GB SSD/Iris Xe Graphics/14 2.5K Resolution/120Hz Display/Win11</p>
                <h5><b><strong>price:$590.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/71KBDHTMKgL._SL1500_.jpg" alt="Card Image 3" style="height:275px;">
            <div class="card-details">
                <h2>
Mi Notebook Pro</h2>
                <p>Mi Notebook Pro QHD+ IPS Anti Glare Display Intel Core i5-11300H 11th Gen 14-inch(35.56 cms) Thin and Light Laptop (16GB/512GB SSD/Iris Xe Graphic card</p>
                <h5><b><strong>price:$590.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
