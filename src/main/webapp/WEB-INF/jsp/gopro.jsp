...
<body>
    ...
    <div class="container">
        <div id="product">
            <img src="https://m.media-amazon.com/images/I/51t6c5t0nDL._SL1500_.jpg" alt="Product Image">
            <div class="details">
                <h2>GO PRO</h2>
                <p>GoPro action camera 4K X-200</p>
                <h2>Price: $29.95</h2>
        ...
        <div class="card" style="margin-top:50px;background-color:#bdd4f2;">
            <img src="https://m.media-amazon.com/images/I/61A31TlXnuL._SL1500_.jpg" alt="Card Image 1" style="height:275px;">
            <h2>GoPro hero 10</h2>
            <div class="card-details">
                <p>
GoPro HERO10 Black - Waterproof Action Camera with Front LCD and Touch Rear Screens, 5.3K60 Ultra HD Video, Optical 1X and Digital 4X 23MP Photos </p>
        ...
        <div class="card"  style="margin-top:50px; background-color:#bfe3c5;">
            <img src="https://m.media-amazon.com/images/I/51t6c5t0nDL._SL1500_.jpg" alt="Card Image 2" style="height:275px;">
            <div class="card-details">
                <h2>GoPro Hero 11</h2>
                <p>GoPro HERO11 Waterproof Action Camera with Front & Rear LCD Screens, 5.3K60 Ultra HD Video, HyperSmooth 5.0,1080p Live Streaming with Enduro Battery</p>
                <h5><b><strong>price:$29.95</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
        ...
        <div class="card"  style="margin-top:50px;background-color:#e8dbda;">
            <img src="https://m.media-amazon.com/images/I/51UVLGMN39L._SL1000_.jpg" alt="Card Image 3" style="height:275px;">
            <div class="card-details">
                <h2>Go Pro 12 </h2>
                <p>GoPro Hero12 Bundle Pack - Includes Hero12 Action Camera, 2-Batteries, Floating Hand Grip, Head Strap, Curved Adhesive Mount, Mounting Buckle, Carrying Case</p>
                <h5><b><strong>price:$10.00</strong></b></h5>
                <a href=""><button>View Details</button></a>
            </div>
        </div>
    </div>
